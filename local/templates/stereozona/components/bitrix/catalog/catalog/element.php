...
define('__CURRENT_PAGE__', 'catalog_detail');
...
$componentElementParams = array(
    ...
    'MESS_NO_PRICE_DETAIL' => (isset($arParams['~MESS_NO_PRICE_DETAIL']) ? $arParams['~MESS_NO_PRICE_DETAIL'] : ''),
    ...
    'MESS_AVAILABLE' => $arParams['MESS_AVAILABLE'],
...
<main class="page-content" id="swup">
    <div class="modal modal--top" id="modalOverview">
        <a class="modal__close" href="#" data-fancybox-close data-no-swup></a>
        <div class="container-fluid px-md-0">
            <?$APPLICATION->ShowViewContent('catalog_element: modal_overview_content');?>
        </div>
    </div>
    <?php
    // modal forms
    include('include/element/modals/cheaper.php');
    include('include/element/modals/one-click-buy.php');
    include('include/element/modals/report-receipt-product.php');
    ?>
        ...
        <div class="tab-content tab-content--slider tab-catalog-items">
            <div class="tab-pane fade u-hidden" id="slider-similar" role="tabpanel">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        'DEFERRED_BLOCK_CODE' => 'slider-similar',
                        'DISPATCH_EVENT' => 'N',
            ...
            <div class="tab-pane fade u-hidden" id="slider-latest" role="tabpanel">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        'DEFERRED_BLOCK_CODE' => 'slider-latest',
                        'DISPATCH_EVENT' => 'Y',
                        'VIEW_PARAMS' => [
                            'ADD_CLASS' => 'item--big',
                            'WRAPPER' => [
