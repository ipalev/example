...
$snippets = [
    BlogParser::SNIPPET => [
        ...
        '<h4##CONTENT##</h4>' => '<div class="article__content"><h4##CONTENT##</h4></div>',
        '<h3##CONTENT##</h3>' => '<div class="article__content"><h3##CONTENT##</h3></div>',
        '<h2##CONTENT##</h2>' => '<div class="article__content"><h2##CONTENT##</h2></div>',
        '<ul>##CONTENT##</ul>' => '<ul class="article__content">##CONTENT##</ul>',
        '<ol>##CONTENT##</ol>' => '<ol class="article__content">##CONTENT##</ol>',
    ]
];
