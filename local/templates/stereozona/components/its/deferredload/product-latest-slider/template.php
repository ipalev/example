...
if($iblock->get('catalog')) {
    ...
    $limit = 10;
    $viewedProducts = \Bitrix\Catalog\CatalogViewedProductTable::query()
    ...
    if ($viewedProducts) {
        $GLOBALS['arrRecentlyProductsFilter'] = [
            'ID' => array_column($viewedProducts, 'PRODUCT_ID')
        ];
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "FILTER_NAME" => "arrRecentlyProductsFilter",
