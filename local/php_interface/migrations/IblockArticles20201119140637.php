...
class IblockArticles20201119140637 extends Version
{
    protected $description = "Инфоблок Статьи и обзоры";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/#IBLOCK_CODE#/index.php',
