...
class iblock_banners20201106114542 extends Version
{
    protected $description = "Создал тип и инфоблок для банеров.";
  ...
  'CODE' => 'top_baner_main',
  'API_CODE' => NULL,
  'NAME' => 'Верхний банер на главной',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/baners/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/baners/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/baners/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'EXTERNAL_ID' => NULL,
  'LANG_DIR' => '/',
  'SERVER_NAME' => 'stereozona.localhost',
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'Y',
      'SORT' => '100',
      'XML_ID' => '7a675fd31206d07adf06a628ee5e811e',
    ),
    1 => 
    array (
      'VALUE' => 'в меню каталога',
      'DEF' => 'N',
      'SORT' => '200',
      'XML_ID' => '81e497f900680e2fb1bbe9de01a03187',
    ),
  ),
));
  ...
  array (
    ...
    'PROPERTY_WHERE_SHOW' => 'Где показывать',
