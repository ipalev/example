...
class NewBannersIblock20201110153843 extends Version
{
    ...
    public function up()
    {
        ...
        $helper->Iblock()->deleteIblockIfExists('top_baner_main');
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'main',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Раздел показа для каталога',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DISPLAY_SECTIONS',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'G',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    'PROPERTY_DISPLAY_SECTIONS' => 'Раздел показа для каталога',
